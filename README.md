...
안녕하세요! 저는 소프트웨어랑 하드웨어에 관심이 생겨 공부하고 있어요!

## 관심사 및 정보
- 최근 관심사로는 **PS(Problem Solving), 자율 주행**을 관심을 두고 있어요.
- 현재는 PS 응애이기 때문에 C++, python, Java 언어를 배우고 있어요.
- 26년 기준으로 경기대학교 전자공학부로 편입했어요.

## 과거 기여 내역 (~ 2024) 
- 과거에는 node.js라는 도구로 간단한 채팅앱을 개발하며 및 디스코드 서드 파티 지원 및 기여 했어요.
- 과거에는 **디스코드 봇 작품**을 집중적으로 만들고 있었답니다.
...
<!--
## TMI(쓸대 없는 정보)
활동명 TMI인데 그 이외에도 `영상, 디자인`에 관심이 많답니다. `그래서 풀 닉네임에 미디어가 나온거고요!`  
